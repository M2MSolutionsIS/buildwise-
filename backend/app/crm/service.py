"""
CRM module service layer — F001–F024.

CRUD operations for Contacts, Interactions, Products, Offers, Contracts, Invoices.
...
async def get_contact(
    ...
    """Get a single contact with persons loaded."""
...
async def create_contact(
    ...
    *,
    ...
    """Create a new contact with optional persons."""
...
async def update_contact(
    ...
    *,
    ...
    """Update a contact. Returns None if not found."""
...
async def create_offer(
    ...
    *,
    ...
    """F008/F009: Create an offer with line items and financial estimates."""
...
async def approve_or_reject_offer(
    ...
    *,
    ...
    """F014: Approve or reject an offer."""
    offer = await get_offer(db, org_id, offer_id)
...
async def get_sales_kpi(db: AsyncSession, org_id: uuid.UUID) -> dict:
    """F023: Sales KPI — aggregate metrics."""
    # Contacts
